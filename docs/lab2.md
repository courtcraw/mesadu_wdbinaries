...
* The greek letter gamma $$\gamma$$ refers to the energy generated by a reaction, and in <code>MESA</code> will often be referred to as simply <code>g</code>.
* The greek letter nu $$\nu$$ refers to a neutrino, and in <code>MESA</code> will often be referred to as <code>neu</code> or rarely <code>n</code>.
* We will use $$e^-$$ to refer to electrons, and in <code>MESA</code> this is usually <code>e</cpde>.
...
Finally, we will use reaction notation in the instructions. If you are unfamiliar, it is a compact notation used to describe nuclear reaction. 
